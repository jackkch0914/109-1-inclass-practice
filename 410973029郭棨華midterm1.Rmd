...
## 前置設定 
frontmatter中studentName的字串值"%name%"請改成"你的中文姓名"。
請先設定UTF-8 text encoding:

Tools > Global Options > Code > Saving (tab)

  * 設定UTF-8的影片：<https://vimeo.com/477880033/3f88b6a8fa>
...
## 考試相關資源及公告
  ...
  * <https://tpemartin.github.io/109-1-midterm1/>
...
```{r ans21}
threeLocalTimes = list(
tokyo = with_tz(as.POSIXlt(threeTimes$tokyo, origin="1970-01-01 00:00:00"),
tzone="Asia/Tokyo"),
chicago = with_tz(as.POSIXlt(threeTimes$chicago, origin="1970-01-01 00:00:00"),
tzone="CST6CDT"),
rome = with_tz(as.POSIXlt(threeTimes$rome, origin="1970-01-01 00:00:00"),
tzone="Europe/Rome")
...
iso = as.character(format_ISO8601(ymd_hms("2021-01-20 15:00:00", tz="Europe/Rome"), usetz=T)),
localTime = as.character(with_tz("2021-01-20 15:00:00", tz="Europe/Rome")),
tz = c("Europe/Rome")
)
...
StudentInfo = list(
IssueNumber = 27,
IssueTitle = "用c( )堆疊記錄全班身高的問題",
IssueLink = "tpemartin/109-1-inclass-practice#27"
)
...
MediaType = as.factor(c("Vimeo_Video", "Google_Classroom", "Rmd_File", "Gitter")),
Link = as.character("https://vimeo.com/showcase/7588787"),
ResponseTimestamp = ymd("2020-10-09", tz="Asia/Taipei")
)
